...
def save_config(data, updated_by=None):
    ...
    if row_id:
        cur.execute('''UPDATE sap_api_config SET
            ...
            igst_tax_code=%s, cgst_tax_code=%s, profit_center=%s,
            ...
            data.get('igst_tax_code') or None, data.get('cgst_tax_code') or None,
            data.get('profit_center') or None,
        ...
        cur.execute('''INSERT INTO sap_api_config
            (environment, base_url, token_url, client_id, client_secret,
             ...
             igst_tax_code, cgst_tax_code, profit_center,
